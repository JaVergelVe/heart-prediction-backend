...
KEY_SHAP_TOP_FACTORS: Final[str] = "shap_top_factors"
KEY_SHAP_FEATURE_NAME: Final[str] = "feature_name"
KEY_SHAP_FEATURE_VALUE: Final[str] = "feature_value"
KEY_SHAP_IMPACT_SCORE: Final[str] = "impact_score"
KEY_SHAP_CONTRIBUTION_SCORE: Final[str] = "contribution_score"
KEY_SHAP_RANK: Final[str] = "rank"
KEY_SHAP_INTERPRETATION: Final[str] = "interpretation"
